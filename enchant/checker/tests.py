...
class TestChecker(unittest.TestCase):
    ...
    def test_filters(self):
        ...
        chkr = SpellChecker(
            "en_US", text=text, filters=[enchant.tokenize.WikiWordFilter]
        )
        for err in chkr:
    ...
    def test_unicode(self):
        ...
        for n, err in enumerate(chkr):
            ...
            if n == 1:
                ...
                self.assertEqual(
                    chkr._replace_words[raw_unicode("strng")], raw_unicode("string")
                )
            if n == 2:
        ...
        self.assertEqual(
            chkr.get_text(), raw_unicode("I am a unicode string with unicode errors.")
        )
